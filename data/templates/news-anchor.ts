  ...
  missionTimeline: [
    {
      ...
      mission: { kind: 'read_script', script: [
        ...
        '국제 뉴스입니다. 정상회담 결과가 곧 발표될 예정입니다.',
        '교통 정보입니다. 출근길 도심 곳곳이 정체되고 있습니다.',
        '환율 소식 전해드립니다. 원달러 환율이 소폭 하락했습니다.',
        '과학 뉴스입니다. 새로운 연구 결과가 학계의 주목을 받고 있습니다.',
        '사회면 소식입니다. 시민 안전을 위한 정책이 발표되었습니다.',
        '오늘의 날씨를 자세히 전해드립니다. 주말까지 맑은 날씨가 이어지겠습니다.',
        '연예 뉴스입니다. 화제의 신작이 내일 공개됩니다.',
        '단독 보도입니다. 현장에 나가있는 특파원을 연결하겠습니다.',
        '독자 여러분 안녕하십니까. 오늘 하루를 정리하는 마감 뉴스입니다.',
        '시청해 주신 여러분께 감사드립니다. 다음 시간에 다시 뵙겠습니다.',
      ] },
      scoreWeight: 1.0,
      hudBinding: 'caption',
    },
