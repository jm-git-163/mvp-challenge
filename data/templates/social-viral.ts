 ...
 *
 * TEAM-TEMPLATE (2026-04-22) — 소셜 바이럴 독립 템플릿.
 *
 * 팔레트: TikTok 세로 UI — 블랙(#000000) + 시안(#00F2EA) + 핑크(#FF0050).
 * BGM: synthwave-128 (트랩/바이럴 느낌 고속 비트).
 */
...
export const socialViral: Template = {
  ...
  layers: [
    { id: 'bg_mesh',       type: 'gradient_mesh',    zIndex: 1, opacity: 1, enabled: true, props: { colors: [BLACK, '#1A0B2E', PINK], rotatePeriodSec: 40 } },
    ...
    { id: 'cue_like',      type: 'kinetic_text',     zIndex: 54, opacity: 1, enabled: true, props: { text: '♥ LIKE!', fontSize: 72, color: PINK, strokeColor: WHITE, strokeWidth: 6, mode: 'pop', position: 'top-center', startMs: 7000, staggerMs: 50 }, activeRange: { startSec: 7, endSec: 12 } },
    { id: 'outro_title',   type: 'kinetic_text',     zIndex: 75, opacity: 1, enabled: true, props: { text: 'GOING VIRAL ⚡', fontSize: 68, color: CYAN, strokeColor: PINK, strokeWidth: 6, mode: 'pop', position: 'top-center', startMs: 15500, staggerMs: 55 }, activeRange: { startSec: 15.5, endSec: 18 } },
